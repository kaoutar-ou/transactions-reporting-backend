...
public class AdriaReportingApplication {
    ...
    CommandLineRunner run(TransactionService transactionService) {
        return args -> {
            Banque banque1 = banqueRepository.save(new Banque(null, "Banque 3", "codeBIC10", "Adresse 1", new ArrayList<Client>(), new ArrayList<Beneficiaire>()));
            Banque banque2 = banqueRepository.save(new Banque(null, "Banque 4", "codeBIC11", "Adresse 2", new ArrayList<Client>(), new ArrayList<Beneficiaire>()));
...
//            clientRepository.save(client1);
            ...
            beneficiaire1.setUsername("busername10");
            beneficiaire1.setEmail("bemail10");
            ...
            beneficiaire2.setEmail("bemail12");
            beneficiaire2.setPassword("bpassword12");
            ...
            beneficiaire3.setUsername("busername13");
            beneficiaire3.setEmail("bemail13");
